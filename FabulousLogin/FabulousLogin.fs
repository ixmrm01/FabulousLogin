...
module App = 
    ...
    let update msg model =
        ...
        | HelloWorldMsg msg, HelloWorldModel m ->
            ...
            match msg with
            | HelloWorldPage.Msg.LoggedOut -> init()
            | _ -> {model with CurrentModel = HelloWorldModel hwm}, Cmd.map HelloWorldMsg hwCmd
    ...
    let view (model: Model) dispatch =
        ...
        | HelloWorldModel m -> HelloWorldPage.view m (HelloWorldMsg >> dispatch)
